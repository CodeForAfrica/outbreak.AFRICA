...
const useStyles = makeStyles(
  ({ breakpoints, palette, typography, widths }) => ({
    ...
    image: {
      maxHeight: "initial",
      minHeight: typography.pxToRem(180),
      minWidth: typography.pxToRem(131),
      ...
      [breakpoints.up("md")]: {
        ...
        margin: `${typography.pxToRem(
          (widths.values.md * 43) / widths.values.xl
        )} ${typography.pxToRem((widths.values.md * 30) / widths.values.xl)}`,
      },
      [breakpoints.up("lg")]: {
        ...
        margin: `${typography.pxToRem(
          (widths.values.lg * 43) / widths.values.xl
        )} ${typography.pxToRem((widths.values.lg * 30) / widths.values.xl)}`,
      },
      [breakpoints.up("xl")]: {
    ...
    <div className={classes.root}>
      ...
      >
        <Grid container direction="row" alignItems="flex-start">
          {documents &&
            documents.map(
              ({ title: documentTitle, description, source, document }) => (
                <DocumentItem
