        ...
        {topicPosts && topicPosts.length > 0 && (
          ...
          >
            <FeaturedCard
              ...
              date={topicPosts[0].acf.attributes && topicPosts[0].attributes.date ? topicPosts[0].attributes.date: topicPosts[0].post_date}
            />
          </Link>
        )}
        <Grid container>
      ...
      {topicPosts && topicPosts.length > 3 && (
          ...
          >
            <FeaturedCard
              ...
              date={topicPosts[4].acf.attributes && topicPosts[4].attributes.date ? topicPosts[4].attributes.date: topicPosts[4].post_date}
            />
          </Link>
        )}
        <Grid container>
